...
{
    [SerializeField] CharacterInputController controller;
    ...
    public override void Enter(AState from)
    {
        ...
        //SaveEarnedCoins.instance.PushData(controller.coins);
        //LeaderboardOperations.instance.PushData(trackManager.score);
