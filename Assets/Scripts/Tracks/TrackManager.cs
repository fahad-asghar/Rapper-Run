...
{
    [SerializeField] GameObject chad;
    [SerializeField] GameObject doge;
    [SerializeField] GameObject elon;
    [SerializeField] GameObject character;
    [SerializeField] ThemeData dayTheme;
    [SerializeField] ThemeData nightTheme;
    ...
    {
        if (name.Equals("day"))
            m_CurrentThemeData = dayTheme;
        else if (name.Equals("night"))
            m_CurrentThemeData = nightTheme;
    }
    ...
    public IEnumerator Begin()
    {
        if (!m_Rerun)
        {
            ...
            GameObject temp = Instantiate(character, Vector3.zero, Quaternion.identity);
